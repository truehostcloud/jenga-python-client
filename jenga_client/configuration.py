...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "SignatureAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = jenga_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.finserve.africa" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("jenga_client")
