...
class MPesaStkPushRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order", "customer", "payment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": MPesaStkPushRequestOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
            "customer": MPesaStkPushRequestCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "payment": MPesaStkPushRequestPayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None
        })
        return _obj
