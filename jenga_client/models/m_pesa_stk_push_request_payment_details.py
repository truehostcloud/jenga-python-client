...
class MPesaStkPushRequestPaymentDetails(BaseModel):
    """
    MPesaStkPushRequestPaymentDetails
    """ # noqa: E501
    msisdn: StrictStr = Field(description="Number to push the STK")
    payment_amount: Union[StrictFloat, StrictInt] = Field(description="Amount to pay on the request", alias="paymentAmount")
    __properties: ClassVar[List[str]] = ["msisdn", "paymentAmount"]
