...
class MPesaCallbackResponseBank(BaseModel):
    """
    MPesaCallbackResponseBank
    """ # noqa: E501
    reference: Optional[StrictStr] = Field(default=None, description="Bank reference")
    transaction_type: Optional[StrictStr] = Field(default=None, description="Transaction type", alias="transactionType")
    account: Optional[StrictStr] = Field(default=None, description="Account number")
    __properties: ClassVar[List[str]] = ["reference", "transactionType", "account"]
