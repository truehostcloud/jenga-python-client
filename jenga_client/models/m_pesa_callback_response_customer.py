...
class MPesaCallbackResponseCustomer(BaseModel):
    """
    MPesaCallbackResponseCustomer
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Customer name")
    mobile_number: Optional[StrictStr] = Field(default=None, description="Customer mobile number", alias="mobileNumber")
    reference: Optional[StrictStr] = Field(default=None, description="Customer reference")
    __properties: ClassVar[List[str]] = ["name", "mobileNumber", "reference"]
