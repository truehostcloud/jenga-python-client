...
class IMTWithinEquityResponse(BaseModel):
    """
    ...
    data: Optional[IMTWithinEquityResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": IMTWithinEquityResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
