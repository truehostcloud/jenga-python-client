...
class EazzyPayMerchantsResponse(BaseModel):
    """
    EazzyPayMerchantsResponse
    """ # noqa: E501
    merchants: Optional[List[EazzyPayMerchant]] = None
    __properties: ClassVar[List[str]] = ["merchants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "merchants": [EazzyPayMerchant.from_dict(_item) for _item in obj["merchants"]] if obj.get("merchants") is not None else None
        })
        return _obj
